            ...
            <div class="col-md-8 text-center">
              <div class="card col-md-8" style="width: 350px; margin:0 auto;">
                <div class="card-body">
                  ...
                  <a href="https://36.37.122.158:8082/{{bucketName}}/{{fileName}}" target="_blank" class="btn btn-outline-primary btn-block" >Open</a>
                  <a href={{url}} class="btn btn-outline-success btn-block" target="_blank">Download</a>
                </div>
              </div>
            </div>
          </div>
