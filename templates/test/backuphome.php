    ...
    <body>
        ...
        <!-- <div class="container">
          <div class="row mt-5 justify-content-center">
            <div class="col-md-8">
              <h1 class="text-center">Open Bucket</h1>
              <form action="{{ url_for('bucket')}}" method="POST">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-append">
                    <button class="btn btn-secondary" type="submit" value='submit' id="search-button">Open</button>
                  </div>
                </div>
              </form>
            </div>
        ...
        <!-- <div class="modal fade" id="modalListBucket" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalListBucketTitle">List Bucket</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">                      
                  <form action="{{ url_for('listbucket')}}" method="POST">
                    <div class="input-group mb-3">
