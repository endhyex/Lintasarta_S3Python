...
<html>
    <head>
        <title>Lintasarta - {{bucketName}}</title>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link">{{bucketName}}</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="{{ url_for('viewfile')}}">View File</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="modal" data-target="#modalUpload">Upload File</a>
                    </li>
        ...
        <div class="container">
          <div class="row mt-5 justify-content-center">
            <div class="col-md-8">
              <h1 class="text-center">Search File</h1>
              <form action="{{ url_for('searchfile')}}" method="POST">
                ...
                <div class="input-group mb-3">
                  <input type="text" name="fileName" class="form-control" placeholder="File Name" aria-label="File Name" aria-describedby="basic-addon2">
                </div>
          ...
          <div style="text-align: center;" class="mt-5">
            <!-- <img type="image" alt="" src="{{ url_for('static',filename="")}}"/><br><br><br> -->
            <div style="text-align: center;" class="mt-5">
                ...
                <div class="modal-content">
                  ...
                  <form action="{{ url_for('uploadfile')}}" method="POST" enctype="multipart/form-data">
                    <div class="input-group">
                        <input type="file" name="fileName" class="btn btn-light"/>
                        </span>
                    </div>
                    <!-- <div class="input-group mb-3">
            ...
            <!-- <div class="modal fade" id="modalFile" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalFileTitle">{{bucketName}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <div class="input-group mb-3">
                      ...
                      <li class="list-group-item w-50">1-file1.doc</li>
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body" style="align:center">
                    <form action="{{ url_for('downloadsample1')}}" method="POST">
                    <div class="input-group mb-3">
                      <input type="text" name="downloadfile" class="form-control" placeholder="Enter file name.." aria-label="Enter file name.." aria-describedby="basic-addon2">
                    </div>
                    
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" name="download" value="download" class="btn btn-success">Download</button>
                  </div>
                  </form>
                </div>
              </div>
            ...
            <!-- <div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body" style="align:center">
                  <form action="{{ url_for('deletesample1')}}" method="POST">
                    <div class="input-group mb-3">
                      <input type="text" name="deletefile" class="form-control" placeholder="Enter file name.." aria-label="Enter file name.." aria-describedby="basic-addon2">
                    </div>
            ...
            <!-- <div class="modal fade" id="modalLocalFile" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    while (($file = readdir($open)) !== FALSE){
                        if($file !== '.' && $file !== '..'){
                          echo '<a href="sample1/'.$file.'" target="_blank">'.$file.'<br></a>';
                        }
                    }
                    closedir($open);
                    ?>
